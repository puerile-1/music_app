    ...
    <div class="me">
        <section class="aui-flexView">
            <header class="aui-navBar aui-navBar-fixed">
                ...
                <a href="javascript:;" class="aui-navBar-item" @click="$router.push('/login')">
            ...
            <section class="aui-scrollView">
                ...
                <div class="aui-chang-list">
                    ...
                    <div class="aui-user-text">
                        ...
                        <span><i class="icon icon-vip" v-if="$store.state.user.userDetail.profile.vipType==0"></i>您还未开通VIP</span>
                        <button>开通会员</button>
                    </div>
                ...
                <div class="aui-palace aui-palace-one">
                    ...
                    <a href="javascript:;" class="aui-palace-grid">
                        <div class="aui-palace-grid-icon">
                            <img src="@/assets/img/云下载.png" alt="">
                        </div>
                        <div class="aui-palace-grid-text">
                            <h2>本地/下载</h2>
                        </div>
                    ...
                    <a href="javascript:;" class="aui-palace-grid">
                        <div class="aui-palace-grid-icon">
                            <img src="@/assets/img/再次购买.png" alt="">
                        </div>
                        <div class="aui-palace-grid-text">
                            <h2>已购</h2>
                        </div>
